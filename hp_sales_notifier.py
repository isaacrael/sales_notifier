# Written By: Gil Rael
# hp_sales_notifier.py will notify Gil Rael via text message if item of interest
# is found on hp.com sales page
...
# locate product of interest that is on sale at hp.com and send
...
# script from the the command line python hp.com.py and the lines below are not commented
...
# open Caliberusa.com sales page
    driver.get("http://store.hp.com/us/en/pdp/business-solutions/hp-elitedesk-800-35w-g2-desktop-mini-pc-%28energy-star%29-w5x49ut-aba")
...
# account to send SMS to any phone number
            client.messages.create(to="+15058330785", from_="+15057966457",
                       ...
                       body="Hello from Pi!.....ON SALE TODAY! : ) HP Elite Desk 800")
...
# account to send SMS to any phone number
        client.messages.create(to="+15058330785", from_="+15057966457",
                    ...
                    body="Hello from Pi!..NO SALE TODAY          : (  On HP Elite Desk 800")
    driver.quit()
locate_sale_item();
