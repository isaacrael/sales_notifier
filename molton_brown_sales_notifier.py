# Written By: Gil Rael
# david_yurman_sales_notifier.py will notify Gil Rael via text message if item(s) of interest
# are on sale on the davidyurman.com web site
...
#    driver.get("http://www.neimanmarcus.com/Brioni-Patchwork-Sport-Shirt-Navy-The-Man-s-Store/prod190480449_cat62330756__/p.prod?icid=&searchType=EndecaDrivenCat&rte=%252Fcategory.jsp%253FitemId%253Dcat62330756%2526pageSize%253D30%2526No%253D0%2526refinements%253D&eItemId=prod190480449&cmCat=product")
    driver.get("http://www.davidyurman.com/world-of-yurman/films/the-willow-collection.html")
    driver.implicitly_wait(30)
    element = driver.find_element_by_class_name("div.copy-text.promo-teaser")
    print(element.text)
    try:
...
# account to send SMS to any phone number
            client.messages.create(to="+15058330785", from_="+15057966457",
                       ...
                       body="Hello from Pi!.....ON SALE TODAY AT NEIMAN MARCUS! : ) Time To Buy ......"
                           "http://www.neimanmarcus.com/The-Mans-Store/Mens-Cologne-Grooming/Mens-Cologne/cat10470747_cat000466_cat000470/c.cat#userConstrainedResults=true&refinements=418&page=1&pageSize=30&sort=PCS_SORT&definitionPath=/nm/commerce/pagedef_rwd/template/EndecaDrivenHome&locationInput=&radiusInput=100&onlineOnly=instore&allStoresInput=false&rwd=true&catalogId=cat10470747&selectedRecentSize=&activeFavoriteSizesCount=0&activeInteraction=true")
...
# account to send SMS to any phone number
        client.messages.create(to="+15058330785", from_="+15057966457",
                       ...
                       body="Hello from Pi!.....NO SALE TODAY AT NEIMAN MARCUS! : (")
    driver.quit()
locate_sale_item();
